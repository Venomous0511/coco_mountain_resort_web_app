...
export default function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 z-20">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-sm text-gray-500 dark:text-gray-400">
            Copyright @ 2024 Coco Mountain Resort. All Rights Reserved
          </p>
        ...
        <div className="mt-16 border-t border-gray-400 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24 dark:border-gray-800">
